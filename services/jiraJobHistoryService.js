...
class JiraJobHistoryService {
    ...
    /**
     * Get the latest job execution for a job name
     * @param {string} jobName - Name of the job
     * @returns {Promise<Object|null>} Latest job execution or null
     */
    async getLatestJobExecution(jobName) {
        try {
            ...
            if (error) {
                throw new Error(`Failed to get latest job execution: ${error.message}`);
            }

            return data;
        } catch (error) {
            logger.error('Error getting latest job execution:', error);
            throw error;
        }
    }
     ...
     * @returns {Promise<Object|null>} Job execution or null
     */
    async getJobExecutionById(executionId) {
        try {
            ...
            if (error) {
                throw new Error(`Failed to get job execution by ID: ${error.message}`);
            }

            return data;
        } catch (error) {
            logger.error('Error getting job execution by ID:', error);
            throw error;
        }
    }
}
